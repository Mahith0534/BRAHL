...
|------|------------|---------|
| **End-user package root** (`dist/FoXYiZ_user/pyUtils/` or `_pyUtils/`) | Editable Analyze/Heal helpers + Create scaffold | `_paths`, `cleaner`, `yVisualizer`, `zDefects`, `zBatchDash`, `scaffold_app_ypad`, `xCustom` |
