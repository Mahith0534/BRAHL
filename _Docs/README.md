...
| [Test_Coverage.md](Test_Coverage.md) | **Coverage strategy** | Creators, Hunters, agents — journeys, negatives, security/PII, AI scoring → Go/No-Go |
...
| `test-coverage` | What to test — journeys, personas, negatives, security/PII, browsers/devices, **AI eval → Go/No-Go** | [Test_Coverage.md](Test_Coverage.md) | Creator, QA Hunter, agents |

**Start here for “why”:** [Vision.md](Vision.md). **How to run / heal:** BRAHL + FoXYiZ. **What to cover:** [Test_Coverage.md](Test_Coverage.md).
